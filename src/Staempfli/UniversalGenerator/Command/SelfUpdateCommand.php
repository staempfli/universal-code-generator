...
class SelfUpdateCommand extends Command
{
    ...
    public function configure()
    {
        ...
        $this->setAliases(['selfupdate'])
            ->setDescription(sprintf('Updates %s to the latest stable version', $this->fileHelper->getCommandName()))
            ->setHelp(<<<EOT
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $updater->setStrategy(PharUpdater::STRATEGY_GITHUB);
    ...
    {
        $composerDecoded = json_decode(file_get_contents($this->fileHelper->getProjectBaseDir() . '/composer.json'));
    ...
    {
        $boxDecoded = json_decode(file_get_contents($this->fileHelper->getProjectBaseDir() . '/box.json'));
